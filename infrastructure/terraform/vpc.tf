...
# ECS Host Security Group (Allow traffic from ALB only)
resource "aws_security_group" "ecs_host" {
  name        = "${var.project_name}-ecs-host-sg"
  description = "Allow traffic from ALB"
  vpc_id      = aws_vpc.main.id

  # Dynamic port mapping range for ECS
  ingress {
  ...
  # Allow SSH for debugging (Optional, can be removed for stricter security)
  # ingress {
  #   description = "SSH"
  #   from_port   = 22
  #   to_port     = 22
